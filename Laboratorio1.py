...
def main():
    ...
    play = True
    while play == True:
        print("Bienvenido al Laboratorio 1 de Lenguajes para Aplicaciones Comerciales")
        print("Seleccione el ejercicio que desea ejecutar:")
        print("1. Conjuntos Frozenset","\n2. Funciones en Python","\n3. Paso de Argumentos","\n4. Paso de Argumentos + Combinado","\n5. Retorno de Valores","\n6. Retornar de Estructura de Datos","\n7. Alcance de Variables","\n8. Modularidad","\n9. Paquetes","\n10. Módulos internos","\n11. Módulos externos","\n12. if __name__","\n13. Manejo de excepciones","\n14. Clases y objetos","\n15. Propertys","\n16. Errores en Atributos","\n17. Atributos error","\n18. Herencia", "\n19. Abstracción", "\n20. Polimorfismo")
        
        ejercicio = input("Ingrese el número del ejercicio que desea ejecutar (1-20) o '0' para terminar: ")
        ...
        match ejercicio:
            ...
            case _:
                print("Opción no válida. Por favor, ingrese un número del 1 al 20 o '0' para terminar.")
